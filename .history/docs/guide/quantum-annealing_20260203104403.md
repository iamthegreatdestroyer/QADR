...
This guide explains the quantum annealing algorithm that powers QADR's
dependency resolution.

## What is Quantum Annealing?

Quantum annealing is an optimization technique inspired by quantum mechanics.
While true quantum annealing requires quantum hardware, QADR uses **simulated
annealing** - a classical algorithm that mimics the same principles.
...
Each worker explores with a different random seed, and the best solution across
all workers is returned.
