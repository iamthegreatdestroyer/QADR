...
The analyzer provides deep insights into your dependency graph without performing full resolution.
...
const gplLicenses = result.licenses.filter(
  l => l.license.includes('GPL')
);
