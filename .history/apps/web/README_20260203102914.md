...
Interactive web dashboard for visualizing and managing dependency resolution with the QADR quantum-annealing algorithm.

## Features

- 📊 **Real-time Dashboard** - Overview of dependency health, vulnerabilities, and updates
...
Overview cards showing total dependencies, vulnerabilities, outdated packages, and up-to-date count.
...
Timeline of recent actions like resolutions, updates, and vulnerability detections.
...
- `.badge`, `.badge-critical`, `.badge-high`, `.badge-medium`, `.badge-low` - Severity badges
